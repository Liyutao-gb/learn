...
import com.lyt.learn.model.CourseFile;
import com.lyt.learn.model.Teacher;
import com.lyt.learn.service.CourseFileService;
...
public class CourseFileController {
	...
	public ModelAndView addCourseFile(
		...
		String fileDir = "F://workspace//.metadata//.plugins//org.eclipse.wst.server.core//tmp1//webapps//learn//upload//" + fileName;// 文件上传路径
	...
	public ModelAndView downFile(@PathVariable("id") Integer id) {
		...
		ModelAndView mav = new ModelAndView();
		mav.addObject("info", "location.href='//learn//upload//" + file.getPath()
				+ "'");
	...
	@ResponseBody()
	public PageInfo<CourseFile> courseFileListByTerm(int page, int pageSize, String content) {
		return courseFileService.searchCourseFileByTerm(page, pageSize, content,0);
	}
}
