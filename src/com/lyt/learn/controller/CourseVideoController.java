...
import com.lyt.learn.model.CourseVideo;
import com.lyt.learn.model.Teacher;
import com.lyt.learn.service.CourseService;
import com.lyt.learn.service.CourseVideoService;
...
public class CourseVideoController {
	...
	public ModelAndView addCourseVideo(
		...
		// 设置视频上传的路径
		String fileDir = "F://workspace//.metadata//.plugins//org.eclipse.wst.server.core//tmp1//webapps//learn//upload//" + fileName;
		// 将内存中的数据写入磁盘
	...
	@ResponseBody()
	public PageInfo<CourseVideo> courseVideoListByTerm(int page, int pageSize,String content) {
		return courseVideoService.searchCourseFileByTerm(page, pageSize,content, 0);
	}
}
