...
import com.lyt.learn.model.Student;
import com.lyt.learn.model.Teacher;
import com.lyt.learn.service.CollegeService;
import com.lyt.learn.service.StudentService;
import com.lyt.learn.service.TeacherService;
...
public class StudentController {
	...
	@ResponseBody()
	public PageInfo<Student> studentListByTerm(int page, int pageSize, String content) {
		return studentService.searchStudentByTerm(page, pageSize, content, 0);
	}
