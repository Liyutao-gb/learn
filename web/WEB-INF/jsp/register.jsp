		...
		<div class="container-login100"
			...
			<div class="wrap-login100 p-l-55 p-r-55 p-t-65 p-b-54">
				...
				<form class="login100-form validate-form"
					action="<%=basePath%>register.html" method="POST">
					<span class="login100-form-title p-b-49 loginTitle" > 英语在线学习平台	</span>
					...
					<div style="margin-top:10px; float:left;">
						...
						<div class="role">
							<input type="radio" id="type2" name="role" value="2" title="学生"
								checked="checked"> <label>学生&nbsp;&nbsp;</label> 
					...
					<div style="text-align:left;">
						<a href="javascript:void(0);" class="txt2"
							style="color:red;font-weight:700;font-size:14px;">提示：注册成功将自动跳转至成功页面</a>
					</div>
					...
					<div class="copyright">	
						<a href="#" target="_blank"> ©2019
							版权所有 || Designed by </a> &nbsp; <a href="#"> 油炸小波 </a>
					</div>
				</form>
			</div>
		</div>
